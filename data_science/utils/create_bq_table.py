...
def main():
    ...
    dataset_name = "claims1"
    claims_csv_filepath = "data_science/utils/data/claims.csv"
    policies_csv_filepath = "data_science/utils/data/policies.csv"
    customers_csv_filepath = "data_science/utils/data/customers.csv"
    ...
    load_csv_to_bigquery(project_id, dataset_name, "claims", claims_csv_filepath)

    # Load the policies data
    print("Loading policies table.")
    load_csv_to_bigquery(project_id, dataset_name, "policies", policies_csv_filepath)

    # Load the customers data
    print("Loading customers table.")
    load_csv_to_bigquery(project_id, dataset_name, "customers", customers_csv_filepath)
